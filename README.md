...
Source code for experimenting modding half life sdk using :
...
This repository aims to implement a feature to issue voice commands to npc(s) and also related gameplay 
mechanic. 
